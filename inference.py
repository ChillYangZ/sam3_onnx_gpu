...
Usage example:
  ...
  python inference.py --input_image ./segmentation_input/test.jpg --output_dir segmentation_output --boxes "pos:5384,2352,397,785" --model_dir ./onnx-models --tokenizer ./onnx-models/tokenizer.json --device cuda
"""
